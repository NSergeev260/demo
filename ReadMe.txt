...
Приминить Liquibase для инициализации БД
Перейти на использование PostgreSQL вместо MySQL
Использовать Docker для развертывания контейнеров с различными СУБД
