...
public class EmulatorControllerAdmin {
    ...
    private static final String URL_BLOCK_CARD = "http://localhost:80/block" +
        "?cardId=" + CARD_ID + "&terminalId=" + TERMINAL_ID;

    private static final String URL_UNBLOCK_CARD = "http://localhost:80/unblock" +
        "?cardId=" + CARD_ID + "&terminalId=" + TERMINAL_ID;

    private static final String URL_IS_BLOCKED_CARDS = "http://localhost:80/isBlocked" +
        "?cardId=" + CARD_ID;

    private static final String URL_GENERATE_CARD = "http://localhost:80/generateMockData" +
